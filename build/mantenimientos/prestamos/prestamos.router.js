...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield controller.nuevoPrestamo(req);
    return res.status(response.statusCode).json(response);
}));
router.get('/todos', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield controller.obtieneTotalidadPrestamos(req);
    return res.status(response.statusCode).json(response);
}));
router.get('/recientes', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield controller.obtieneUltimosPrestamos(req);
    return res.status(response.statusCode).json(response);
}));
...
exports.prestamosRuta = { router, endpoint };
