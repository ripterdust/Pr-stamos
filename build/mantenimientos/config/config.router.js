...
exports.configRuta = void 0;
const express_1 = require("express");
const auth_middleware_1 = require("../../common/middlewares/auth.middleware");
const config_controller_1 = require("./config.controller");
const router = (0, express_1.Router)();
const endpoint = '/config';
const controller = new config_controller_1.ConfigController();
...
router.post('/edit/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield controller.modificarCaja(req);
    return res.status(response.statusCode).json(response);
}));
...
exports.configRuta = { router, endpoint };
