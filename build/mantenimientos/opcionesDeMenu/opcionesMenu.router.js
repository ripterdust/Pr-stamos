...
exports.opcionesMenuRuta = void 0;
const express_1 = require("express");
const auth_middleware_1 = require("../../common/middlewares/auth.middleware");
const opcionesMenu_controller_1 = require("./opcionesMenu.controller");
const router = (0, express_1.Router)();
const endpoint = '/opcionesMenu';
const controller = new opcionesMenu_controller_1.OpcionesMenuController();
...
router.get('/obtenerOpciones', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield controller.obtenerOpciones(req);
    return res.status(response.statusCode).json(response);
}));
...
exports.opcionesMenuRuta = { router, endpoint };
